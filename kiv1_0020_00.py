...
def laske_perus_ilmasto(
    ...
    """
    Laskee yksinkertaistetun planeetan ilmaston 12 kuukaudelle.

    Mukana:
        - auringon säteily
        - korkeusvaikutus
        - ilmakehän kiertosolut / tuuli
        - orografinen sade
        - sadevarjo
        - meren etäisyysvaikutus
        - mereltä tuleva kosteuden kulkeutuminen
        - maan kosteuden vuodenaikainen vaihtelu
        - haihdunta
        - suhteellinen kosteus
        - pilvisyys
        - kuivan maan ylimääräinen lämpeneminen
        - meren suuri lämpökapasiteetti

    Parametrit
    ----------
    relief : 2D numpy.ndarray
        Maaston korkeus metreinä.
        Muoto [height, width].

    t_mean : float
        Planeetan keskimääräinen lämpötila °C.

    delta_t : float
        Peruslämpötilan vuodenaikainen vaihtelu.
    ...
    P : float
        Vuoden pituus suhteessa Maahan.
        Vaikuttaa sademäärän kokonaismäärään.
    ...
    t_min = t_mean - delta_t / 2.0
    t_max = t_mean + delta_t / 2.0
    ...
    sea = seamask.astype(float)
    land = landmask.astype(float)
    ...
    # Suunta lähimpään mereen
    merisuunta_x, merisuunta_y = merisuunnan_laskenta(
        seamask
    )
    ...
    # ============================================================
    # UUSI: KOSTEUS JA MEREN LÄMPÖMUISTI
    # ============================================================

    # Maan alkuperäinen vesimäärä.
    #
    # 0 = täysin kuiva
    # 1 = hyvin märkä
    #
    # Aloitetaan maa hieman kosteana.
    ...
    # Meri pysyy aina kosteana.
    maankosteus[seamask] = 1.0

    # Meren lämpötila.
    #
    # Tämä muuttuu hitaasti kuukausien välillä.
    # Siten meri tasaa vuodenaikojen lämpötilavaihtelua.
    meri_temp = np.full(
        (height, width),
        t_mean,
        dtype=float
    ...
    # ============================================================
    # MEREN VAIKUTUKSEN PITUUS
    # ============================================================

    # 500 km:n mittakaava.
    #
    # 0 km       -> vaikutus 1
    # 500 km     -> vaikutus ~0.37
    # 1000 km    -> vaikutus ~0.14
    # 2000 km    -> vaikutus ~0.018
    #
    # Tätä voi säätää esimerkiksi 300000...1000000.
    ...
    for kk in range(12):
        ...
        # Tässä vaiheessa käytetään alustavaa lämpötilaa.
        ...
        # ========================================================
        # MEREN KOSTEUSVAIKUTUS
        # ========================================================

        #
        # Meri vaikuttaa eniten kun:
        #
        #   1. ollaan lähellä merta
        #   2. tuuli puhaltaa mereltä
        #   3. vaakatuuli on voimakas
        #
        ...
        # ========================================================
        # KORKEUDEN VAIKUTUS LÄMPÖTILAAN
        # ========================================================

        lapse_rate = (
        6.5
        + 1.5 * math.log10(planet_atmosphere_pressure)
        )
        ...
        * gee_earths
        ...
        # ========================================================
        # VÄLIAIKAINEN MAA/MERI-LÄMPÖTILA
        # ========================================================

        # Meri ei reagoi yhtä voimakkaasti kuin maa.
        #
        # 0.15 = kuinka nopeasti meri seuraa
        #        hetkellistä lämpötilaa.
        #
        meri_temp += (
            t_pohja -
            meri_temp
        ...
        # Meri reagoi hitaammin myös korkeuteen.
        meri_temp_korkeus = np.where(
            relief < 0,
            0.0,
            korkeus_lampo
        )
        ...
        # Tuuli lisää mereltä tulevaa lämpötilan tasausta.
        meri_lampo_vaikutus *= (
            0.3 +
            0.7 *
            T_tuulensuunta
        ...
        # Lämmin ja märkä pinta haihduttaa paljon.
        #
        # Haihdunta jäähdyttää pintaa.
        #
        ...
        # Haihdunnan aiheuttama jäähdytys.
        haihdunta_lampo = (
            5.0 *
            haihdunta
        )
        ...
        # Kuiva maa lämpenee enemmän.
        #
        # Maksimivaikutus tässä 8 °C.
        #
        kuivuus_lampo = (
            8.0 *
            kuivuus *
        ...
        # ========================================================
        # ILMAKEHÄN YKSINKERTAINEN VESIHÖYRYMALLI
        # ========================================================

        # Kyllästyskosteuden suhteellinen lämpötilariippuvuus.
        #
        # Tämä ei ole täydellinen psykometrinen malli,
        # mutta toimii hyvin tämän mittakaavan simulaatiossa.
        ...
        #
        # Tässä kosteus suhteutetaan lämpötilan mukaiseen
        # kyllästyskosteuteen.
        #
        ...
        # ========================================================
        # MEREN VAIKUTUS SATEESEEN
        # ========================================================

        # Lähellä merta sateen kosteussyöttö on suurempi.
        #
        # Mutta sisämaassa vaikutus voi kadota kokonaan.
        ...
        # ========================================================
        # LÄMPÖTILAN VAIKUTUS SATEEN VESIMÄÄRÄÄN
        # ========================================================
        ...
        # ========================================================
        # MAANKOSTEUDEN PÄIVITYS
        # ========================================================

        # Sade lisää vettä maahan.
        #
    ...
    # ============================================================
    # LOPULLINEN KALIBROINTI
    # ============================================================

    # Alkuperäisen mallisi kalibroinnit.

    kk_temp = kk_temp - 8

    kk_sade = kk_sade * 0.95
...
def laske_planeetan_imasto_parametrit(dem, relief, landmask):
    ...
    #clouds=np.copy(precip_annual)/1200
    #clouds=np.where(clouds>0.6,0.6, clouds)
    #cloudsea=np.copy(landmask)
    #cloudsea=np.where(cloudsea==0,0.6,0.4)
    #clouds=np.where(clouds<cloudsea, clouds, cloudsea)
    #clouds=
    #plt.imshow(clouds)
    #plt.show()
    #quit(-1)
