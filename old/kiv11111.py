...
def laske_planeetan_lampotila(
    ...
    if planet_atmosphere_pressure <= 0:
        raise ValueError("planet_atmosphere_pressure pitää olla > 0.")
    ...
    dF_co2 = (
        5.35
        * math.log(
            (planet_atmosphere_pressure*atmos_co2_ppm) / co2_viite_ppm
        )
    )
...
def calculate_culture_static():
    ...
    intelligence_list=[landmask*suurin_manner_mask, bio1, bio12, relief]
    ...
    alku_x=agriculture_pixels[0,0]
    alku_y=agriculture_pixels[0,1]
    agriculture_index,pastoral_index,suitability,kulttuuri,leviamisaika,vaesto,carrying_capacity=levia(alku_x, alku_y,relief,bio1,bio12,ajo_vuodet=5000)
    print(leviamisaika)
    ...
    ag_lon=agriculture_coords[0,0]
    ag_lat=agriculture_coords[0,1]
