...
## TODO virhe korjatatva, sadevarjot työn alla
...
# ============================================================
#
# False = Tellurus generoi maaston normaalisti
...
def draw_mountain_ranges(
    ...
    plt.title(
        "Tellurus V8.3 — tektonisten vuorijonojen rakenne"
    )
...
def draw_world_relief(
    ...
    ax.set_title(
        f"Tellurus V8.3 — relief, joet, kauppa ja sivilisaatio — seed {SEED}",
        fontsize=17
    )
...
plt.title(
    "Tellurus V8.3 — sivilisaatiopotentiaali"
)
...
plt.title(
    "Tellurus V8.3 — vuosisade + mantereisuus"
)
...
plt.title(
    "Tellurus V8.3 — tuulen vaikutus kosteuden kulkeutumiseen"
)
...
plt.title(
    "Tellurus V8.3 — tuulen kuljettama merikosteus"
)
...
plt.title(
    "Tellurus V8.3 — vuoristojen sadevarjot"
)
...
plt.title(
    "Tellurus V8.3 — vuoristot ja niiden sadevarjot"
)
...
print()
print("=" * 60)
print("TELLURUS V8.3 — YHTEENVETO")
print("=" * 60)
