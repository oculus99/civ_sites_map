...
if __name__ == "__main__":
    ...
    lampotilat_12= np.broadcast_to(lampotilat[np.newaxis, :, :], (12, height, width))
    sateet_12= np.broadcast_to(sateet[np.newaxis, :, :], (12, height, width))   
    ...
    glacier_mask=jaatikko_tulos["glacier_mask"]
   ...
   # 3. Kutsutaan aluohjelmaa laskentaa varten
    ...
    print(f"Kulttuurimn alkupaikka pikseli ({kulttuuri_x}, {kulttuuri_y}) -> K Longitude: {kulttuuri_lon:.4f}, K Latitude: {kulttuuri_lat:.4f}")    
